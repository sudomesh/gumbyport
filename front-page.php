...
-->
                                        <p class="hs-disclaimer">Community driven, open source, peer-to-peer internet. Watch the video below for more information on mesh networking, and stay tuned for updates from the People's Open Network.</p>
<!--                                </form>-->
    ...
    <!-- /END: Features Section -->
		...
		<section class="site-section section-signup">
            ...
            <a href="/how-to-help" class="btn-side animate-on-scroll" data-scrollanimation="fadeInLeft">
